* 论文笔记归档
    ...
    * 智能故障诊断
      ...
      - [Bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network](\papers_notes\故障诊断\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network.md)
    * [回归问题](/notes/回归问题.md)
* AI算法
