...
![1](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\1.jpg)
...
![3](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\3.jpg)
...
![4](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\4.jpg)
...
![5](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\5.jpg)
...
![8](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\8.jpg)

![9](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\9.jpg)

训练和测试数据集划分如下：

![3](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\3.PNG)
...
![10](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\10.jpg)
...
![11](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\11.jpg)
...
![12](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\12.jpg)
...
![13](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\13.jpg)
...
![14](\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\14.jpg)
...
<img src="\bearing fault diagnosis based on vibro-acoustic data fusion and 1D-CNN network\4.PNG" alt="4" style="zoom:50%;" />
